...
public class DoctorDashboard3 extends javax.swing.JFrame {
    ...
    public DoctorDashboard3() {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM DoctorDashboard3");
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 130, 118, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 120, 556, 98));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(776, 306, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorDashboard3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoctorDashboard3().setVisible(true);
            }
        });
    }
